...
class pinchStream(object):
    ...
    def drawCascade(T_units='°C', Q_units='kW'):
        ...
        heatCascade.title("Cascade of temperature intervals,"
...
if __name__ == '__main__':
    ...
    data.streamData(Q_units='kcal/h')
    data.drawStreams(Data="6", Q_units='kcal/h')
    data.shiftedTemperatures()
    data.initialGridDiagram(Data="6")
    data.drawIntervals(Data="6")
    data.cascadeTable(Q_units='kcal/h')
    data.compositeCurve(Data="6", Q_units='kcal/h')
    data.grandCompositeCurve(Data="6", Q_units='kcal/h')
