...
* <a href="https://www.codecogs.com/eqnedit.php?latex=T_{min}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?T_{in}" title="T_{in}" /></a> or <a href="https://www.codecogs.com/eqnedit.php?latex=T_{start}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?T_{in}" title="T_{start}" /></a>
* <a href="https://www.codecogs.com/eqnedit.php?latex=T_{min}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?T_{out}" title="T_{out}" /></a> or <a href="https://www.codecogs.com/eqnedit.php?latex=T_{target}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?T_{out}" title="T_{target}" /></a>
